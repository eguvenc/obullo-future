	...
	Datepicker.prototype = {
		...
		_trigger: function(event, altdate){
			...
			this.element.trigger({
				type: (event == 'hide') ? '' : event, /* Rabih, Burak : Custom update, preventing triggering 'hide' event */
				date: local_date,
...
(function($, window, document, undefined) {
    ...
    Timepicker.prototype = {
        ...
        getTemplate: function() {
            ...
            if (this.showInputs) {
                hourTemplate = '<input type="text" name="hour" style="padding:0px;display:inline-block;" class="bootstrap-timepicker-hour form-control" maxlength="2"/>';
                minuteTemplate = '<input type="text" name="minute" style="padding:0px;display:inline-block;" class="bootstrap-timepicker-minute form-control" maxlength="2"/>';
                secondTemplate = '<input type="text" name="second"  style="padding:0px;display:inline-block;" class="bootstrap-timepicker-second form-control" maxlength="2"/>';
                meridianTemplate = '<input type="text" name="meridian"  style="padding:0px;display:inline-block;" class="bootstrap-timepicker-meridian form-control" maxlength="2"/>';
            } else {
        ...
        updateFromWidgetInputs: function() {
            ...
            console.log($('input.bootstrap-timepicker-hour', this.$widget).val())
