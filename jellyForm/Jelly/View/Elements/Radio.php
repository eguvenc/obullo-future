 ...
 */
Class Jelly_View_Elements_Radio implements Jelly_View_Elements_ElementsInterface
{
    /**
     * Constructor
     * 
    ...
    public function render(Jelly_View_View $view)
    {
        ...
        $element.= $this->formElement->radio($data[Jelly_Form::ELEMENT_NAME], $data[Jelly_Form::ELEMENT_VALUE], $data['checked'], $data[Jelly_Form::ELEMENT_ATTRIBUTE]);
