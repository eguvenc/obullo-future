 ...
 */
Class Jelly_View_Elements_Reset implements Jelly_View_Elements_ElementsInterface
{
    /**
     * Constructor
     * 
    ...
    public function render(Jelly_View_View $view)
    {
        ...
        $element.= $this->formElement->reset($data[Jelly_Form::ELEMENT_NAME], $data[Jelly_Form::ELEMENT_VALUE], $data[Jelly_Form::ELEMENT_ATTRIBUTE]);
...
/* Location: .Obullo/Jelly/Reset.php */