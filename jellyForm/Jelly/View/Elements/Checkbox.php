 ...
 */
Class Jelly_View_Elements_Checkbox implements Jelly_View_Elements_ElementsInterface
{
    /**
     * Constructor
     * 
    ...
    public function render(Jelly_View_View $view)
    {
        ...
        $element.= $this->formElement->checkbox($data[Jelly_Form::ELEMENT_NAME], $data[Jelly_Form::ELEMENT_VALUE], '', $data[Jelly_Form::ELEMENT_ATTRIBUTE]);
        ...
        return $element;
        // return $this->jellyForm->getElementDiv($element, $extra[Jelly_Form::ELEMENT_LABEL]);
    }
}
...
/* Location: .Obullo/Jelly/Checkbox.php */