 ...
 */
Class Jelly_View_Elements_Upload implements Jelly_View_Elements_ElementsInterface
{
    /**
     * Constructor
     * 
    ...
    public function render(Jelly_View_View $view)
    {
        ...
        $element.= $this->formElement->upload($data[Jelly_Form::ELEMENT_NAME], $data[Jelly_Form::ELEMENT_VALUE], $data[Jelly_Form::ELEMENT_ATTRIBUTE]);
