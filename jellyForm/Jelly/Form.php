 ...
 */
Class Jelly_Form extends Jelly_Adapter
{
    /**
     * Tablename constants
     */
    ...
    {
        $permSave = new Jelly_Html_Form_Permission_Save($this->c);
        $permSave->add($data);
    }
    ...
    public function render($operationName = '')
    {
        ...
        $formData = $this->getFormAttributes(
            array(
                static::FORM_PRIMARY_KEY,
                static::FORM_ID,
                static::FORM_ATTRIBUTE,
                static::FORM_ACTION,
                static::FORM_NAME
            )
        );
