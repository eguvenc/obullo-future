...
use RuntimeException,
    Permissions\Rbac\Page,
    Permissions\Rbac\Utils,
    Permissions\Rbac\Object,
    Permissions\Rbac\Operation,
    Permissions\Rbac\Model\User as ModelUser;
...
Class User
{
    ...
    const CACHE_HAS_GET_ALL_PERMISSIONS = 'Permissions:Rbac:User:hasGetAllPermissions:';       // Obullo\Permissions\Rbac\Page->getPermissions();
